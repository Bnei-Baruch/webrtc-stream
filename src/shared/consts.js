...
export const http_servers_options = [
...
export const audios_options = [
    ...
    { key: 'am', value: 58, flag: 'et', text: 'Amharic' },
    ...
    { key: 'ab', value: 70, text: 'Azerbaijani' },
...
export const dual_languages = [
    ...
    { key: 'am', value: "amn", flag: 'et', text: 'Amharic' },
